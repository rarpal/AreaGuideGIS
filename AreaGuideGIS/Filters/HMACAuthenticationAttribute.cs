...
namespace AreaGuideGIS.Filters
{
    // This authentication filter attribute is only for experimenting and not used at present
    // It could be used to secure a Web API for this app
    ...
    public class HMACAuthenticationAttribute : Attribute, IAuthenticationFilter
    {
        ...
        public HMACAuthenticationAttribute()
        {
            ...
            {
                // Hard coded at present, but should ideally be fetched from the user registration database
